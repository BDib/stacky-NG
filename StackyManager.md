...
4. **Manual Pinning**: To pin a shortcut to your Windows Taskbar, go to `Settings > Shortcut Management > Open Shortcuts Directory`, then right-click the desired shortcut and select "Pin to taskbar".
